        ...
        <div class="col-md-8">
            ...
            @endif
                ...
                @endif
                    ...
                    <h1>Import Global Derivative</h1>
                    <p class=' text-info p-2'>Check the file is Global Derivatives or not.  </p>
                    <form action="globalderivative/store" id="frm-create-course" method="post" enctype="multipart/form-data">
                    @csrf
