        ...
        <section class="content">
            ...
            <form action="{{route('editUserAction')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-5">
                    <label for="password"><a style="color:red;">Wanna change Password...?? if not then leave empty</a></label>
                ...
                <div class="form-group  col-md-5">
                    <label for="password_confirmation"><a style="color:red;"> Confirm_Password... if not then leave empty</a></label>
                ...
                <div class="form-group  col-md-6">
                    ...
                    <select name="role" id="deals" class="form-control"
                        ...
                        <option disabled selected>-------Select Role to user--------</option>
            ...
            <div class="col-md-4">
                <img src="{{url('uploads/users/'.$userData->image)}}" class="img-fluid img-thumbnail">
            </div>
